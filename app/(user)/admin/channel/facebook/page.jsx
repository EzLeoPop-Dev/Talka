...
import { ArrowLeft, Facebook, CheckCircle2, MessageSquare, Zap, Link2, Shield } from "lucide-react";
        ...
        <div className="flex-1 flex flex-col items-center justify-center relative z-10">
          <div className="max-w-2xl w-full text-center flex flex-col items-center">
            ...
            <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-2xl bg-white text-slate-700 text-[10px] font-black uppercase tracking-[0.2em] mb-14 border border-slate-100 shadow-sm">
              ...
              <span className="text-[#BE7EC7]">Authorized Meta Integration Hub</span>
            </div>

            {/* Connection Visual (Message <-> Facebook) */}
            ...
            <h1 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tighter mb-6">
              Connect <span className="text-[#1877F2]">Facebook</span>
            </h1>
            <p className="text-slate-400 text-lg leading-relaxed mb-12 max-w-lg mx-auto font-medium">
              After clicking the button below, you will be redirected to Facebook to select the business accounts you want to sync.
            </p>
            ...
            >
              ...
              <span className="text-sm font-black uppercase tracking-[0.2em]">Connect with Facebook</span>
            </button>
            ...
            <div className="mt-16 flex items-center gap-8 opacity-40 grayscale">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest">Official Meta API</span>
                </div>
            </div>
          </div>
        </div>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-md flex items-center justify-center z-[200] p-4 animate-in fade-in duration-300">
          <div className="bg-white p-12 rounded-[3.5rem] border border-slate-100 shadow-2xl max-w-sm w-full text-center animate-in zoom-in-95 duration-300">
            <div className="w-24 h-24 bg-emerald-50 rounded-[2.5rem] flex items-center justify-center mx-auto mb-8 text-emerald-500 shadow-inner">
            ...
            <p className="text-slate-400 mb-10 font-medium text-sm leading-relaxed">
              Account has been authorized. You can now manage your pages from the dashboard.
            </p>
            <button
              onClick={() => setShowModal(false)}
              className="w-full py-5 bg-[#BE7EC7] text-white rounded-2xl text-xs font-black uppercase tracking-[0.25em] hover:bg-[#a66bb0] transition shadow-lg shadow-[#BE7EC7]/30 active:scale-95"
            >
              Finish Setup
            </button>
          </div>
